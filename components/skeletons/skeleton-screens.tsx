...
export const CardSkeleton = () => (
  <View className="bg-surface rounded-2xl p-5 shadow-rn-sm mb-4 border border-neutral-medium-1">
...
export const ListItemSkeleton = () => (
  <View className="bg-surface rounded-lg p-4 mb-3 shadow-rn-sm border border-neutral-medium-1">
