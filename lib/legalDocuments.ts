...
- Device information (e.g., operating system, app version, unique identifiers)
- App interactions and feature usage

### Subscription & Payment Data
- Subscription status and transaction information (handled by Apple App Store or Google Play Store; MastersFit does not store your full payment details)

### Feedback & Communications
- Messages, bug reports, survey responses, or other input you voluntarily provide

## 2. How We Use Your Information

We use your data to:
- Deliver and personalize workout plans
- Track progress and store workout history
- Operate, maintain, and improve the App's features and performance
- Communicate with you regarding updates, support, and offers
...
- Data is stored securely in cloud services using encryption at rest and in transit.
- Access to your data is restricted to authorized personnel.
- While we take industry-standard precautions, no system is 100% secure, and we cannot guarantee absolute protection.
...
- Exercising additional rights under applicable laws (e.g., GDPR in the EU, CCPA in California)

Requests can be made by contacting us at the address below.

## 7. Children's Privacy

MastersFit is intended for users 18 years or older. We do not knowingly collect data from individuals under the age of 18. If we learn we have collected such data, we will delete it.

## 8. International Users

If you access the App outside the United States, your data may be transferred to and processed in the U.S. By using the App, you consent to such transfers in compliance with applicable law.
