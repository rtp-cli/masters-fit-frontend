        ...
        <View className="bg-white rounded-xl p-5 shadow-sm">
          <View className="flex-col items-start mb-4">
            <View className="flex items-center justify-center flex-row mb-4">
              <Ionicons name="warning" size={24} color={colors.brand.secondary} />
            ...
            <View className="flex-1">
              <Text className="text-base text-text-secondary leading-6 mb-3">
                MastersFit provides fitness guidance only and is not medical advice. Always
                check with your doctor before starting new workouts.
              </Text>
              <Text className="text-base text-text-secondary leading-6 mb-3">
                Our workouts are AI-powered, but AI isn't perfect — listen to your body
                and use your judgment.
              </Text>
              <Text className="text-base text-text-secondary leading-6 mb-3">
                By using this app, you agree to do so at your own risk and release
                MastersFit LLC from any liability for injuries, health issues, or damages.
              </Text>
              <Text className="text-base font-medium text-text-primary">Results are not guaranteed.</Text>
            </View>
          </View>
        </View>
      </View>
